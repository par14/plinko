import { ACTIVE_AREA_HEIGHT, INITIAL_SIZES_FOR_8_LINES } from "@pages/Plinko/components/Game/config";
import type { LinesType, SizeConfig } from "@pages/Plinko/components/Game/interfaces";
