...
export const configSlice = createSlice({
  ...
  reducers: {
    ...
    setLinesCount: (state, action: PayloadAction<Pick<Config, "linesCount">>) => {
...
export const { setBet, setRiskMode, setLinesCount, addGameRunning, removeGameRunning, setLastWin, clearConfig } = configSlice.actions;
